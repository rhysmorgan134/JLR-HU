...
export default function MediaProgress({trackTime, playTime}) {
    ...
    return(
        <Box sx={{flexGrow: 1, display: 'flex', alignItems: 'center'}}>
            ...
            <LinearProgress variant={'determinate'} value={normalise()} sx={{flexGrow: 1, height: '10px', borderRadius: 5, marginLeft: '1rem', marginRight: '1rem'}}/>
